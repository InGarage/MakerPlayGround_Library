#include "MP_ARDUINOALL_115.h"

 MP_ARDUINOALL_115::MP_ARDUINOALL_115(uint8_t s0,uint8_t s1,uint8_t s2,uint8_t s3,uint8_t out,uint8_t LED,const String &tag)
